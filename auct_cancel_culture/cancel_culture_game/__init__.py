...
def create_round(subsession):
    ...
    if subsession.round_number == 1:
        ...
        ses_params = {
            ...
            'TimeMessages': [[[[0, 'Эксперты предсказывают падение акций компании 4', True],
                               [30, 'Ожидается падение рынка', True],
                               [60, 'Наблюдается снижение спроса на услуги компании 1', True],
                               [90, 'Значительно вырос  спрос на услуги компании 5', True],
                               [120, 'Возможны значительные скачки цен на акции компании 5', True],
                               [150, 'Наблюдается рост спроса на услуги компании 1', True],
                               [180, 'Снижение спроса на услуги компании 5', True],
                               [210, 'Ожидается падение рынка', True],
                               [240, 'Ожидаются значительные скачки цен на акции компании 4', True],
                               [270, 'Ожидаются значительные скачки цен на акции', True],
                               [300, 'Рынок акций сильно переоценен', True],
                               [330, 'Продолжается рост спроса на услуги компании 5', True],
                               [360, 'Нет новостей', False]]],
                             [[[0, 'Эксперты предсказывают падение акций компании 4', True],
                               [30, 'Ожидается падение рынка', True],
                               [60, 'Ожидается снижение спроса на услуги компании 1', True],
                               [90, 'Увеличивается спрос на услуги компании 5', True],
                               [120, 'Ожидаются значительные скачки цен на акции компании 5', True],
                               [150, 'Произошел рост спроса на услуги компании 1', True],
                               [180, 'Наблюдается снижение спроса на услуги компании 5', True],
                               [210, 'Ожидается падение рынка', True],
                               [240, 'Ожидаются значительные скачки цен на акции компаний 3, 5', True],
                               [270, 'Ожидаются значительные скачки цен на акции', True],
                               [300, 'На рынке акций сильный прирост частных инвесторов', True],
                               [330, 'Продолжается рост спроса на услуги компании 5', True],
                               [360, 'Нет новостей', False]]],
                             [[[0, 'Ожидается падение акций компании 4', True],
                               [30, 'Ожидается падение рынка', True],
                               [60, 'Наблюдается снижение спроса на услуги компании 1', True],
                               [90, 'Увеличивается спрос на услуги компании 5', True],
                               [120, 'Возможны значительные скачки цен на акции компании 5', True],
                               ...
                               [180, 'Снижение спроса на услуги компании 5', True],
                               [210, 'Ожидается падение рынка', True],
                               [240, 'Ожидаются значительные скачки цен на акции компании 3', True],
                               [270, 'Ожидаются значительные скачки цен на акции', True],
                               [300, 'На рынке акций сильный прирост частных инвесторов', True],
                               [330, 'Продолжается рост спроса на услуги компании 5', True],
                               [360, 'Нет новостей', False]]],
                             [[[0, 'Вероятно падение акций компании 4', True],
                               [30, 'Ожидается падение рынка', True],
                               [60, 'Ожидается снижение спроса на услуги компании 1', True],
                               [90, 'Наблюдается увеличение спроса на услуги компании 5', True],
                               [120, 'Ожидаются значительные скачки цен на акции комании 3', True],
                               [150, 'Наблюдается рост спроса на услуги компании 1', True],
                               [180, 'Наблюдается снижение спроса на услуги компании 5', True],
                               [210, 'Ожидается падение рынка', True],
                               [240, 'Ожидаются значительные скачки цен на акции компании 4', True],
